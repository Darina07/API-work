...
class GetProjectsServiceTest extends SuppTest
{
    /**
     * @return void
    ...
    {
        $this->loadDataSet();
        $service = $container->get(GetProjectsService::class);
    ...
    private function validAdminRequest($roleID)
    {
        ...
        $jsonResponsePath = dirname(__FILE__) . "/fixtures/responses/validAdminGetProjectsResponse.json";
