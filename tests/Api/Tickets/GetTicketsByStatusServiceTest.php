...
class GetTicketsByStatusServiceTest extends SuppTest
{
    /**
     * @return void
    ...
    {
        $this->loadDataSet();
        $service = $container->get(GetTicketsByStatusService::class);
    ...
    private function validAdminRequest($roleId)
    {
        ...
        $jsonResponsePath = dirname(__FILE__) . "/fixtures/responses/validAdminGetTicketsByStatusResponse.json";
