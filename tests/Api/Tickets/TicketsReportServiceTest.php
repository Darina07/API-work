...
class TicketsReportServiceTest extends SuppTest
{
    /**
     * @return void
    ...
    {
        $this->loadDataSet();
        $service = $container->get(TicketsReportService::class);
    ...
    private function validAdminRequest($roleId)
    {
        ...
        $jsonResponsePath = dirname(__FILE__) . "/fixtures/responses/validAdminGetTicketsReportResponse.json";
