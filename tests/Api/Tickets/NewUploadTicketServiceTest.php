...
class NewUploadTicketServiceTest extends SuppTest
{
    use FileUploadTrait;
    /**
     * @return void
                                 ...
                                 Uploads $expectedUpload)
    {
        ...
        $service = $container->get(NewUploadTicketService::class);
    ...
    private function validRequest()
    {
        ...
        $expectedUpload->ticket = 1;
        $expectedUpload->comment = null;
        $expectedUpload->upload_type = "ticket";

        $routeArgs = ['id' => 1];
        $jsonPayload = '{"id":1,"original_file_name":"test.jpg","url":"https://dev.support.hph.io/uploads/9f052830-c39a-4bac-81a2-64bf78c38030.jpg","created_on":"04/07/2022 @ 10:21 AM","mime_type":"image/jpeg","uploaded_by":1,"uploaded_by_name":"Kaloyan Stoyanov","ticket":1}';
