...
class GetTicketsByCategoryServiceTest extends SuppTest
{
    /**
     * @return void
    ...
    {
        $this->loadDataSet();
        $service = $container->get(GetTicketsByCategoryService::class);
    ...
    private function validAdminRequest($roleId)
    {
        ...
        $jsonResponsePath = dirname(__FILE__) . "/fixtures/responses/validAdminGetTicketsByGategoryResponse.json";
