...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='1=reply; 2=internal;';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `comments` VALUES (2,3,1,1,'2023-03-13 19:03:48','Example comment reply'),(3,3,2,1,'2023-03-13 19:04:12','Example comment internal'),(4,3,1,1,'2023-03-13 20:32:10','some comment');
...
INSERT INTO `tickets` VALUES (3,3,3,1,'2023-03-13 20:06:19');
...
INSERT INTO `users` VALUES (1,'kaloyan@hph.io','kaloyan@hph.io','$2y$10$fqew8TQSNDBRcXugHh2D2elmkSsH8Vd0vs0CnkeQoI2xJb/2XEVee',NULL,1,'Kaloyan','Stoyanov','2022-04-05 12:17:14',NULL,1,NULL,NULL,'a815a6a2-7d50-11ed-a6c9-f0d4e2e605b0'),(3,'test@test.bg','test@test.bg','1234',NULL,3,'Test','Test','2023-03-13 21:13:17','2023-03-13 21:13:17',1,NULL,1,'0ce1a472-baad-11ed-8a45-cae72503a121');
...
-- Dump completed on 2023-03-31 19:08:37
