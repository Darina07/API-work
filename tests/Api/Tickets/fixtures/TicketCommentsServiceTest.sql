...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `support_local` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='1=reply; 2=internal;';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `comments` VALUES (2,3,1,1,'2023-03-13 19:03:48','Example comment reply'),(3,3,2,1,'2023-03-13 19:04:12','Example comment internal');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Holds the user roles in the system.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ticket_progress` (
  ...
  KEY `ticket_progress_comments_id_fk` (`comment_id`),
  CONSTRAINT `ticket_progress_comments_id_fk` FOREIGN KEY (`comment_id`) REFERENCES `comments` (`id`),
  CONSTRAINT `ticket_progress_ticket_status_id_fk` FOREIGN KEY (`status`) REFERENCES `ticket_status` (`id`),
...
INSERT INTO `ticket_progress` VALUES (3,2,2,2,NULL,'2023-03-14 22:45:40'),(4,2,2,2,NULL,'2023-03-14 22:52:21'),(5,3,2,1,2,'2023-05-22 13:29:35'),(6,3,2,1,3,'2023-05-22 13:29:49');
...
INSERT INTO `tickets` VALUES (3,3,3,1,'2023-03-13 18:18:48');
...
INSERT INTO `uploads` VALUES (1,'test.jpg','/home/didityyyy/uploads/9f052830-c39a-4bac-81a2-64bf78c38030.jpg','https://dev.support.hph.io/uploads/9f052830-c39a-4bac-81a2-64bf78c38030.jpg',1,'image/jpeg','2023-03-15 21:33:12','ticket',1,NULL,'dd9816890bc4db3414c8cd4b6585964580c7aa14'),(2,'test.jpg','/home/didityyyy/uploads/9f052830-c39a-4bac-81a2-64bf78c38030.jpg','https://dev.support.hph.io/uploads/9f052830-c39a-4bac-81a2-64bf78c38030.jpg',1,'image/jpeg','2023-03-15 21:44:28','comment',NULL,2,'dd9816890bc4db3414c8cd4b6585964580c7aa14'),(3,'test.jpg','/home/didityyyy/uploads/9f052830-c39a-4bac-81a2-64bf78c38030.jpg','https://dev.support.hph.io/uploads/9f052830-c39a-4bac-81a2-64bf78c38030.jpg',1,'image/jpeg','2023-03-15 21:33:12','ticket',1,NULL,'dd9816890bc4db3414c8cd4b6585964580c7aa14'),(4,'test.jpg','/home/didityyyy/uploads/9f052830-c39a-4bac-81a2-64bf78c38030.jpg','https://dev.support.hph.io/uploads/9f052830-c39a-4bac-81a2-64bf78c38030.jpg',1,'image/jpeg','2023-03-15 21:44:28','comment',NULL,2,'dd9816890bc4db3414c8cd4b6585964580c7aa14');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Holds JWTs that are used as bearer tokens for acces.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'kaloyan@hph.io','kaloyan@hph.io','$2y$10$fqew8TQSNDBRcXugHh2D2elmkSsH8Vd0vs0CnkeQoI2xJb/2XEVee',NULL,1,'Kaloyan','Stoyanov','2022-04-05 12:17:14',NULL,1,NULL,NULL,'a815a6a2-7d50-11ed-a6c9-f0d4e2e605b0');
...
-- Dump completed on 2023-05-22 13:31:05
