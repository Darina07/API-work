...
class SuperAdminTicketsByCategory implements TicketsByCategoryInterface
{
    ...
    {
        return $this->getTicketsByCategoryData($routeArgs['filter']);
    }

    private function getTicketsByCategoryData($filter)
    {
        $sql = <<<SQL
SELECT  t.id as id,
        t.title,
